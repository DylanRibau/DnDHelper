...
export class AddCreaturesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var action3 = new SimpleKVstring();
    action3.name = "Detect";
    action3.value = "Detect things lmao";
    var action4 = new SimpleKVstring();
    action4.name = "BOOP";
    action4.value = "Boop the creature on the head";
    this.creature.legendary_actions.value = "The goblin can take 78 legendary actions, choosing from .....";
